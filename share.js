...
if(document.querySelector('.repository-description')){
  var d = document.querySelector('.repository-description').innerText;
}
var sh_link = "https://twitter.com/intent/tweet?text=" + document.title + "%20-%20" + d + "%20" + document.location
